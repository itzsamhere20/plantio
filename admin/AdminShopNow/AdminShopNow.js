...
export default function AdminShopNow() {
...
const clearForm=()=>
{
  ...
  return (
    ...
    <div className='flex flex-col w-[100%] h-auto px-5 lg:px-10'>
      ...
      <div className='flex flex-wrap flex-row w-[100%]  font-libre text-xl leading-[24px] md:text-3xl pt-10   text-gray-800 gap-[5px]'>Shop Now Section <i className='text-green-900'>Configuration</i></div> 
