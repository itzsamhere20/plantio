...
export default function NotFound() {
  return (
    <div className='w-[100%] flex  flex-col min-h-[85vh] justify-center items-center border-b 2xl:px-[10%] fhd:px-[15%] 4k:px-[25%]'><h1 className='text-[10rem] lg:text-[10rem] font-libre'>404</h1>
