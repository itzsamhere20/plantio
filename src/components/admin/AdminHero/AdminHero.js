...
console.log('Title 1 is : ',Title1)
console.log('Title 2 is : ',Title2)
...
const clearForm=()=>
{
  ...
  return (
    ...
    <div className='flex flex-col w-[100%] h-auto px-5 lg:px-10'>
      ...
      <div className='flex flex-wrap flex-row w-[100%]  font-libre text-xl leading-[24px] md:text-3xl pt-10   text-gray-800 gap-[5px]'>Hero Section <i className='text-green-900'>Configuration</i></div> 
...
{/* ------------------------section  title area---------------------------- */}
        ...
        <div className={section_title_area}>
          ...
          <div className='flex flex-col gap-2 w-[100%] lg:w-[50%]'>
           <p className=' px-1 lg:px-5'>Title line #1</p>
          <input  id='section_title1' placeholder='Write 1st line of title' className={section_input}onChange={(e)=>setTitle1(e.target.value)} />
          </div>


          <div className='flex flex-col gap-2 w-[100%] lg:w-[50%]'>
           <p className='px-1 lg:px-5'>Title line #2</p>
           <input id='section_title2' placeholder='Write 2nd line of title' className={section_input} onChange={(e)=>setTitle2(e.target.value)} />
          </div>

          <div className='flex flex-col gap-2 w-[100%] lg:w-[50%]'>
           <p className='px-1 lg:px-5'>Italic words</p>
           <input id='section_italic' placeholder='Write italic words here' className={section_input} onChange={(e)=>setItalic(e.target.value)} />
          </div>
        
        
        </div>

{/* ------------------------------ color and paragraph area-------------------- */}
        
        <div className={section_title_area}>


        <div className='flex flex-col gap-2 w-[100%] lg:w-[50%]'>
           <p className='px-1 lg:px-5'>Background Color</p>
           <input id='section_bgcolor' placeholder='Type section background color here' className={section_input}  onChange={(e)=>setColor(e.target.value)}/>
          </div>
