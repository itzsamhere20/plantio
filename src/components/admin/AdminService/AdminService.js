...
const clearForm=()=>
{
  ...
  return (
    ...
    <div className='flex flex-col w-[100%] h-auto px-5 lg:px-10'>
      ...
      <div className='flex flex-wrap flex-row w-[100%]  font-libre text-xl leading-[20px] md:text-3xl pt-10   text-gray-800 gap-[5px]'>Service Section <i className='text-green-900'>Configuration</i></div> 


{/* ---------------------Add section Button --------------------------- */}

<div className='flex w-[100%] py-10'>
  <button className=' w-max h-max px-6 md:px-7  py-3 md:py-3 bg-green-900 rounded-md text-[13px] md:text-md lg:text-lg hover:bg-green-800 text-white' onClick={()=>setShowForm(true)}>Add Service</button>
  </div>
...
{/* -------------------------------section  title area----------------------------------- */}
        ...
        <div className={section_title_area}>
          ...
          <input  id='section_title1' placeholder='Write title here' className={section_input}onChange={(e)=>setTitle(e.target.value)} />
          </div>
