...
const clearForm=()=>
{
  ...
  return (
    ...
    <div className='flex flex-col w-[100%] h-auto px-5 lg:px-10'>
      ...
      <div className='flex flex-wrap flex-row w-[100%]  font-libre text-xl leading-[24px] md:text-3xl pt-10   text-gray-800 gap-[5px]'>Story Section <i className='text-green-900'>Configuration</i></div> 
...
{/* ------------------------section  title area---------------------------- */}
        ...
        <div className={section_title_area}>
          ...
          <div className='flex flex-col gap-2 w-[100%] lg:w-[50%]'>
           <p className=' px-1 lg:px-5'>Platform </p>
         
               <select id="platform"   className={section_input} onChange={(e)=>setPlatform(e.target.value)} required>
          ...
          <div className='flex flex-col gap-2 w-[100%] lg:w-[50%]'>
           <p className='px-1 lg:px-5'>Link</p>
    
           <input id='url' placeholder='Type link URL here' className={section_input} onChange={(e)=>setUrl(e.target.value)} required/>
          </div>
 ...
 {/* --------------------------image area---------------------------- */}
        ...
        <input type="file" id="img"className="hidden" name='img' onChange={(e)=>uploadImage(e)} required />
        <label for="img" className='flex w-[100%] md:w-max flex-wrap justify-center items-center text-white text-[13px] md:text-lg bg-green-900  py-4 gap-3 md:gap-5 px-1 md:px-8 hover:bg-green-800 '><BiUpload className='text-lg md:text-3xl '/>Choose Thumbnail</label>
        </div>
        {img!==null &&
