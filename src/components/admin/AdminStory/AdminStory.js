...
{/* ------------------------section  title area---------------------------- */}
        ...
        <div className={section_title_area}>
          ...
          <div className='flex flex-col gap-2 w-[100%] lg:w-[50%]'>
           <p className=' px-1 lg:px-5'>Title </p>
...
{/* ------------------------------ color and paragraph area-------------------- */}
        ...
        <div className='flex flex-col gap-2 w-[100%] lg:w-[50%]'>
           <p className='px-1 lg:px-5'>URL</p>
           <input id='section_bgcolor' placeholder='Type Video URL here ' className={section_input}  onChange={(e)=>setUrl(e.target.value)}/>
          </div>
