...
export default function Discount() {
  return (
    <div className='flex flex-col md:flex-row py-10 sm:py-16 md:py-20 lg:py-24 w-[100%] h-max justify-center items-center bg-pink-100 lg:bg-pink-50 gap-5 lg:gap-10'>
