...
export default function Discount() {
  return (
    <div className='flex flex-col md:flex-row py-10  md:py-16 lg:py-20 w-[100%] 2xl:w-[80%] fhd:w-[70%] 4k:w-[50%] h-max justify-center items-center bg-pink-100 lg:bg-pink-50 gap-5 lg:gap-10 2xl:mx-[10%] fhd:mx-[15%] 4k:mx-[25%]'>
        <img src={fast_delivery} className='w-[70px] m:w-[100px] hover:animate-shake' />
