...
<div className='flex flex-col w-[100%] lg:w-[90%]  h-[100%]  ml-0 py-4 lg:ml-[10%] justify-center items-center lg:items-start pl-[5%] lg:pl-[10%] pr-[5%] lg:pr-[0%] text-center lg:text-left'>
  ...
  <button className='flex bg-green-950 text-white text-[11.5px]  tracking-[2px] w-max mt-[28px] md:mt-[38px] lg:mt-[44px] font-poppins uppercase py-4 md:py-4 px-7 md:px-9 hover:bg-gray-950 transition-[4.3s] transition-all-ease-in-out '>Our Stories</button>
