...
export default function ProductDetail() {
  ...
  const pm_button =
    ...
    if(isProductExist) {
      ...
      localStorage.setItem('cart', JSON.stringify([...cart, {...cartProduct, quantity: qty}]))
    }
          ...
          >
            <div className="relative my-6 mx-auto w-[90%]">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <img src={product.image} alt={product.title} className="w-[100px] h-[100px] object-contain" />
                   
                  <p className="my-4 w-[70%] text-blueGray-500 text-sm lg:text-lg leading-relaxed  px-5">
                    
                  {product.title} 
                  </p>
                  <p className="flex  w-[10%] font-semibold justify-end items-center text-gray-900">X {qty}</p>
                </div>
                {/* ------------------------------remove-buton----------------------------- */}
                <div className="text-xs font-poppins pt-5  flex w-[100%] justify-end right-0 ">
                <p className="cursor-pointer hover:text-red-500 w-max" onClick={()=>removeProduct(product.id)}>Remove</p>
                </div>
                </div>
                {/*footer*/}
                {/* ----------------------------modal Buttons------------------------------- */}
      ...
      <div className="mt-10 md:mt-0 lg:mt-24 border-b-[1px] border-gray-300">
        ...
        {loading ? (
          <div
            ...
            className=" z-[1000] flex fixed top-0 w-[100vw] h-[100vh] justify-center items-center bg-[rgb(1,1,1,0.9)]"
          >
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="flex w-[100%] flex-col lg:flex-row h-auto py-10 lg:py-10 px-5 md:px-10 lg:px-32 border-b-[1px] border-gray-200"
          >
            {/* -------------------------left-side-------------- */}
            ...
            <div className=" shadow-md md:shadow-lg rounded-xl w-[100%] lg:w-[50%] pt-10 px-5 py-5 lg:px-10">
              ...
              >
                <div className="flex w-[100%] gap-1 ">
                  ...
                  <button className="flex w-[65%] lg:w-[70%] bg-gray-500 px-6 lg:py-3 justify-center items-center text-white font-poppins text-md lg:text-lg duration-300 hover:bg-green-800 " onClick={()=>{AddProductToCart(product);setShowModal(true)}}>
                    Add to cart
                  </button>
              ...
              <div className="flex flex-col font-poppins text-sm  text-gray-500 gap-4 md:gap-6 py-10 font-[400] tracking-[0.2px]">
                <p className="flex gap-2 ">
                  Sku:{" "}
                  <span className="text-black font-[500]">{product.id}</span>
                </p>
        ...
        <Swiper
          ...
          modules={[Pagination]}
          className="w-[90%] mx-[5%] px-10   h-[350px] md:h-[420px] lg:h-[500px] flex mb-10"
        >
          {categoryData
            .filter((item) => {
              return item.id != id;
